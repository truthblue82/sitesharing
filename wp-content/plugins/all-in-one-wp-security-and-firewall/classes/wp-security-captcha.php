...
class AIOWPSecurity_Captcha
{
    ...
    //YEN add this function
    function display_captcha_form_for_contact()
    {
        $cap_form = '<p class="aiowps-captcha"><label>'.contact_answer_number.'</label>';
        $cap_form .= '<div class="aiowps-captcha-equation"><strong>';
        $maths_question_output = $this->generate_maths_question();
        $cap_form .= $maths_question_output . '</strong></div></p>';
        echo $cap_form;
    ...
    function generate_maths_question()
    {
        ...
        $equation_string .= '<input type="text" size="2" maxlength="2" id="aiowps-captcha-answer" name="aiowps-captcha-answer" value="" />';
