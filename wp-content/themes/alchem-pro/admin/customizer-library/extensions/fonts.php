...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'alchem-pro' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'alchem-pro' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'alchem-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'alchem-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'alchem-pro' ),
		'devanagari'   => __( 'Devanagari', 'alchem-pro' ),
		'greek'        => __( 'Greek', 'alchem-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'alchem-pro' ),
		'khmer'        => __( 'Khmer', 'alchem-pro' ),
		'latin'        => __( 'Latin', 'alchem-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'alchem-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'alchem-pro' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'alchem-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'alchem-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'alchem-pro' ),
