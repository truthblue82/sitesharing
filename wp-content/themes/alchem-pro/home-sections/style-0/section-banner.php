...
<?php elseif( $content_model == 2 ):?>
              ...
              <div class="section-content">
                <div class="container">
                  <div class="<?php echo $alchem_home_animation;?>" data-animationduration="0.9" data-animationtype="bounce" data-imageanimation="no">
                    <h1 class="magee-heading"><span class="heading-inner <?php echo 'alchem_section_0_title_'.$i;?>"><?php echo do_shortcode($title);?></span></h1>
                  </div>
  ...
  <div class="section-content container alchem_section_0_model">
    ...
    <?php if( $button_text != '' ){?>
    <div style="text-align:<?php echo $content_align;?>" class="alchem_section_0_button_text"> <a href="<?php echo $button_link;?>" target="<?php echo $button_target;?>" class="magee-btn-normal btn-md btn-line btn-light"><?php echo $button_text;?></a> </div>
    <?php }?>
    <?php endif;?>
    <?php if( $content_model == 1 ):?>
