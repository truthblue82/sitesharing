<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-13 alchem-home-style-0';
 ...
 <div class="section-content" style="color:<?php echo $section_color;?>;">
  ...
  <?php if( $section_title != '' ):?>
    <h2 style="text-align: center" class="section-title alchem_section_13_title"><?php echo $section_title;?></h2>
