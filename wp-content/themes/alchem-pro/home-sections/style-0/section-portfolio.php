<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-12 alchem-home-style-0';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
    <h2 style="text-align: center" class="section-title alchem_section_12_title"><?php echo $section_title;?></h2>
    ...
    <div class="section-subtitle alchem_section_12_sub_title"><?php echo do_shortcode($sub_title);?></div>
      ...
      <?php endif;?>
    <div class="<?php echo $alchem_home_animation;?>" data-animationduration="1.2" data-animationtype="zoomIn" data-imageanimation="no">
    <div style="color:#fff;" class="alchem_section_12_posts_num">
     <?php
	 $portfolio_item   = '';
	 $html    = '';
	 $j           = 0;
