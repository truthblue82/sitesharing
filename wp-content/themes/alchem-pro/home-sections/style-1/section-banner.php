    ...
    <div class="section-content">
      <div class="container">
        <div class="<?php echo $alchem_home_animation;?>" data-animationduration="0.9" data-animationtype="bounce" data-imageanimation="no" >
           <h1 class="magee-heading"><span class="heading-inner <?php echo 'alchem_section_0_title_'.$i;?>"> <span style="font-family: 'Cuprum';"><?php echo do_shortcode($title);?></span></span></h1>
        </div>
        ...
        <div style="text-align: center;" class="<?php echo 'alchem_section_0_btn_text_'.$i;?>">
         <?php if( $btn_text!='' ):?>
          <a href="<?php echo $btn_link;?>" target="<?php echo $btn_target;?>" class="magee-btn-normal btn-rounded btn-lg">
