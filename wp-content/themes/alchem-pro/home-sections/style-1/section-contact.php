<?php 
  // section news 
   ...
   $receiver        = esc_attr(alchem_option('section_13_receiver'));
   $display_terms   = esc_attr(alchem_option('section_13_display_terms'));
   $terms_text      = wp_kses(alchem_option('section_13_terms_text'), $allowedposttags);
   $gmap_api        = esc_attr(alchem_option('gmap_api'));
   
   $section_class = 'section magee-section alchem-home-section-13 alchem-home-style-1';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $content_model == 0 ):?>
   <?php if( $section_title != '' ):?>
    ...
    <div style="text-align:center;" class="section-subtitle alchem_section_13_sub_title"><?php echo do_shortcode($sub_title);?></div>
