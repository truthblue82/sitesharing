<?php 
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
    ...
    <div style="text-align:center;" class="section-subtitle alchem_section_9_sub_title"><?php echo do_shortcode($sub_title);?></div>
  ...
  <div class="'.$alchem_home_animation.'" data-animationduration="0.9" data-animationtype="fadeInDown" data-imageanimation="no">
    <div class="img-frame rounded alchem_section_9_partner_'.$j.'">
      ...
      <a target="_blank" href="'.esc_url($links[$j]).'" data-placement="top" data-toggle="tooltip" title="'.esc_attr( $titles[$j]).'"> <img src="'.esc_url($partner).'" class="feature-img ">
  ...
  <div class="'.$alchem_home_animation.'" data-animationduration="0.9" data-animationtype="fadeInDown" data-imageanimation="no">
    <div class="img-frame rounded alchem_section_9_partner_'.$j.'">
      <div class="img-box figcaption-middle text-center fade-in" style="border-radius:0;"> 
       <img  data-placement="top" data-toggle="tooltip" title="'.esc_attr( $titles[$j]).'" alt="'.esc_attr( $titles[$j]).'" src="'.esc_url($partner).'" class="feature-img ">
        <div class="img-overlay dark">
          <div class="img-overlay-container">
            <div class="img-overlay-content"> <i class="fa fa-link"></i> </div>
          </div>
