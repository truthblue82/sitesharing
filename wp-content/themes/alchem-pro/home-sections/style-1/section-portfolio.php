<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-12 alchem-home-style-1';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
    ...
    <div style="text-align:center;" class="section-subtitle alchem_section_12_sub_title"><?php echo do_shortcode($sub_title);?></div>
