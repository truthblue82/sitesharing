...
// section team
   ...
   $section_class = 'section magee-section alchem-home-section-11 alchem-home-style-1';
 ...
 <?php if( $section_hide != '1' ):?>
  ...
  <?php if( $section_title != '' ):?>
    <h2 class="section-title alchem_section_11_title" ><?php echo $section_title;?></h2>
    <div style="text-align:center;" class="section-subtitle alchem_section_11_sub_title"><?php echo do_shortcode($sub_title);?></div>
