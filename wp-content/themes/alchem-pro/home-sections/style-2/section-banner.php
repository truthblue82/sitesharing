        ...
        <div class=" row">
          <div class="col-md-6">
            <div class="<?php echo $alchem_home_animation;?>" data-animationduration="0.9" data-animationtype="bounce" data-imageanimation="no">
              <h1 class="magee-heading"><span class="heading-inner <?php echo 'alchem_section_0_title_'.$i;?>" style="font-family: 'Poiret One'"><?php echo do_shortcode($title);?></span></h1>
            </div>
            ...
            <div style="text-align:center;" class="<?php echo 'alchem_section_0_btn_text_'.$i;?>">
             <?php if( $btn_text!='' ):?>
              <a href="<?php echo $btn_link;?>" target="<?php echo $btn_target;?>" class=" magee-btn-normal btn-full-rounded btn-md btn-line"><?php echo $btn_text;?></a>
               <?php endif;?>
              </div>
          </div>
