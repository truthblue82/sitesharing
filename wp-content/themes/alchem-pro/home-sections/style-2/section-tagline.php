...
<section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <div class="<?php echo $alchem_home_animation;?>" data-animationduration="0.9" data-animationtype="fadeInRight" data-imageanimation="no">
    <div class="magee-promo-box">
      ...
      <h1 class="magee-heading"><span class="heading-inner alchem_section_1_slogan_title"><span style="font-family: 'Poiret One';font-size:24px;"><?php echo $slogan_title;?></span></span></h1>
