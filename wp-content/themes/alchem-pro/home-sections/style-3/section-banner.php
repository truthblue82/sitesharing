<?php 
   ...
   $youtube_mute = 'false';
	...
	$containment = 'body';
	 ...
	 $section_class = 'section magee-section alchem-home-section-0 alchem-home-style-3';
  if( $content_model == 3 )
      ...
      <div class="container-fullwidth">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <span class="magee-dropcap dropcap dropcap-boxed" style="border-radius:2px;background-color:#2c818c; margin-bottom:15px;">
              <div style="height:30px;"></div>
              <div style="font-family: 'Cabin Condensed';" class="<?php echo 'alchem_section_0_title_'.$i;?>"><?php echo do_shortcode($title);?></div>
              <div class="clear"></div>
              </span>
              <div class="clear"></div>
            </div>
            ...
            <span class="magee-dropcap dropcap dropcap-boxed" style="border-radius:2px;background-color:#2c818c;margin-bottom:15px;">
              ...
              <div style="font-size: 20px; font-family: 'Lato';" class="<?php echo 'alchem_section_0_sub_title_'.$i;?>"><?php echo do_shortcode($sub_title);?></div>
              <div class="clear"></div>
              </span>
              <div class="clear"></div>
            </div>
            <div class="magee-animated " data-animationduration="0.9" data-animationtype="fadeInUp" data-imageanimation="no">
              <div style="text-align: left;" class="<?php echo 'alchem_section_0_btn_text_'.$i;?>">
               <?php if( $btn_text!='' ):?>
                <a href="<?php echo $btn_link;?>" target="<?php echo $btn_target;?>" style="" class="magee-btn-normal btn-rounded btn-md"><i class="fa fa-th-list "></i> <?php echo $btn_text;?></a>
                 <?php endif;?>
                 </div>
            </div>
          </div>
