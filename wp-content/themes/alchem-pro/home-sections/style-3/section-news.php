<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-8 alchem-home-style-3';
   if( alchem_option('section_8_parallax') == '1' )
   $section_class .= ' parallax-scrolling';
 ?>
<?php if( $section_hide != '1' ):?>
<style>
.alchem-home-section-8 .entry-box, .alchem-home-section-8 .entry-box a, .alchem-home-section-8 .entry-title {
color:<?php echo $section_color;
?>;
}
</style>
...
<div class="section-content" style="color:<?php echo $section_color;?>;">
  <div class="container alchem_section_8_model">
    ...
    <h1 class="magee-heading section-title alchem_section_8_title"> <span class="heading-inner"><?php echo $section_title;?></span> </h1>
    <div class=" divider divider-title divider-border center">
      <div class="divider-inner divider-border"></div>
    </div>
    <p class="section-subtitle alchem_section_8_sub_title"><?php echo do_shortcode($sub_title);?></p>
...
while ( have_posts() ) : the_post();  
	...
	if( has_post_thumbnail()  ){
		...
		$featured_image = '<div class="entry-aside col-md-4">
