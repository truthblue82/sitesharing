<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-12 alchem-home-style-3';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
    <h1 class="magee-heading " style="text-align:center;"><span class="heading-inner alchem_section_12_title"> <span style="font-family: 'Cabin Condensed'; font-size: 32px;color:#1d1d1d;"><?php echo $section_title;?></span></span></h1>
