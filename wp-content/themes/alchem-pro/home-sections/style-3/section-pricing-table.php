...
// section team
   ...
   $section_class = 'section magee-section alchem-home-section-11 alchem-home-style-3';
 ...
 <?php if( $section_hide != '1' ):?>
  ...
  <?php if( $section_title != '' ):?> 
    <h1 class="magee-heading " style="text-align:center;"><span class="heading-inner alchem_section_11_title"> <span style="font-family: 'Cabin Condensed'; font-size: 32px;"><?php echo $section_title;?></span></span></h1>
