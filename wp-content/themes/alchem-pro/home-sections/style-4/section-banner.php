<?php 
 ...
 $youtube_mute = 'false';
  ...
  $containment = 'body';
   ...
   $section_class = 'section magee-section alchem-home-section-0 alchem-home-style-4';
  if( $content_model == 3 )
...
<div class="item">
  <section  class="section magee-section section-banner fullheight verticalmiddle <?php echo 'alchem_section_0_image_'.$i;?>" style="background-image: url(<?php echo $image;?>);background-repeat:repeat;">
    <div class="section-content">
      <div class="container">  
            <div class="magee-animated animated fadeIn" data-animationduration="0.9" data-animationtype="fadeIn" data-imageanimation="no" >          
                <h1 class="magee-heading ">
                  <span class="heading-inner <?php echo 'alchem_section_0_title_'.$i;?>" style="font-size: 70px;font-weight: 400;margin-top: 0;margin-bottom: 10px;"> 
                      <span style="font-family: 'Cinzel';"><?php echo do_shortcode($title);?></span>
                      </span> 
                </h1>
                <p style="text-align:left; font-size: 20px;font-family: 'Lato';" class="<?php echo 'alchem_section_0_sub_title_'.$i;?>"><?php echo do_shortcode($sub_title);?></p>
                <div class=" divider divider-border" style="margin-top:; margin-bottom:;width:80px;">
                    <div class="divider-inner divider-border" style="border-bottom-width:3px; "></div>
                </div>
                <div style="height:10px;"></div>
                <div style="text-align:left;" class="<?php echo 'alchem_section_0_btn_text_'.$i;?>">
                 <?php if( $btn_text!='' ):?>
                    <a href="<?php echo $btn_link;?>" target="<?php echo $btn_target;?>" style="" class=" magee-btn-normal btn-square btn-line">
                       <i class="fa fa-th-list " style="visibility: visible;"></i>
                        <?php echo $btn_text;?></a>
                         <?php endif;?>
                </div>
            </div>
  ...
  <div class="section-content container alchem_section_0_model">
   <?php if( $content_model == 0 ):?>
    ...
    <div style="text-align:<?php echo $content_align;?>" class="alchem_section_0_button_text">
      <a href="<?php echo $button_link;?>" target="<?php echo $button_target;?>" class="magee-btn-normal btn-md btn-line btn-light"><?php echo $button_text;?></a>
      </div>
      <?php }?>
