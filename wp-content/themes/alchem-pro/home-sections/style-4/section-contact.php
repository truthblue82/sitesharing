<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-13 alchem-home-style-4';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
    <h2 class="section-title alchem_section_13_title" style="text-align:center;margin-bottom:30px;margin-top:80px;"><?php echo $section_title;?></h2>
    <div style="text-align:center;" class="alchem_section_13_sub_title"><?php echo do_shortcode($sub_title);?></div>
	...
	$shortcode = '[ms_row]
		...
		[ms_google_map address="'.$address.'" type="roadmap" overlay_color="" infobox_background_color="#ffffff" infobox_text_color="#000000" infobox_content="'.do_shortcode($infobox_content).'" icon="" width="100%" height="450px" zoom="14" scrollwheel="yes" scale="yes" zoom_pancontrol="yes" popup="yes" animation="yes" class=""][/ms_google_map]
		</div>
		[/ms_column]
		[ms_column style="1/2"]
