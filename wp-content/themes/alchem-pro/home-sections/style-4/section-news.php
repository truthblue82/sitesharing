<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-8 alchem-home-style-4';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
    <h2 class="section-title alchem_section_8_title" style="text-align:center;margin-bottom:30px;margin-top:80px;"><?php echo $section_title;?></h2>
