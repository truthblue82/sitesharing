...
// section team
   ...
   $section_class = 'section magee-section alchem-home-section-11 alchem-home-style-4';
 ...
 <?php if( $section_hide != '1' ):?>
  ...
  <?php if( $section_title != '' ):?>
    <h2 class="section-title alchem_section_11_title" style="text-align:center;margin-top:80px;margin-bottom:30px;"><?php echo $section_title;?></h2>
    <div style="text-align:center;" class="alchem_section_11_sub_title"><?php echo do_shortcode($sub_title);?></div>
