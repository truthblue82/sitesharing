<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-14 alchem-home-style-4';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
   <h2 class="section-title alchem_section_14_title" style="text-align:center;margin-bottom:30px;margin-top:80px;"><?php echo $section_title;?></h2>
    <div style="text-align:center;" class="alchem_section_14_sub_title"><?php echo do_shortcode($sub_title);?></div>
