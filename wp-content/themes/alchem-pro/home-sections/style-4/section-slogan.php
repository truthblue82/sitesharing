<?php 
  // section slogan 
   ...
   $section_class = 'section magee-section alchem-home-section-10 alchem-home-style-4';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  <div class="section-content" style="color:<?php echo $section_color;?>;background-color:#1d1d1d;">
  ...
  <h1 class="magee-heading" style="text-align:center;"><span class="heading-inner alchem_section_10_title" style="font-size: 62px;"> <span style="font-family: 'Cabin Condensed';font-size:24px;"><?php echo $section_title;?></span></span></h1>
   <div style="height:40px;"></div>
   <?php endif;?>
  <div style="text-align:center;margin-bottom:50px;" class="alchem_section_10_button_text">
  <?php if( $button_text!='' ):?>
