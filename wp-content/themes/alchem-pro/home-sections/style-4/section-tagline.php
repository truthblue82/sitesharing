<?php 
   ...
   $section_class = 'section magee-section alchem-home-section-1 alchem-home-style-4';
...
<section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <div class="row">
    <h1 class="magee-heading" style="text-align: center;"><span class="heading-inner alchem_section_1_slogan_title" style="font-size: 62px;">
    <span style="font-family: 'Lato'; font-size: 24px; color:#fff;"><?php echo $slogan_title;?></span></span></h1>
    <p style="text-align: center;color:#fff;" class="alchem_section_1_slogan_content"><?php echo do_shortcode($slogan_content);?></p>
    <div style="height: 20px;"></div>
    <div style="text-align:center;" class="alchem_section_1_button_text">
    <a href="<?php echo $button_link;?>" target="<?php echo $button_target;?>" class="magee-btn-normal btn-square btn-md"><i class="fa fa-th-list "></i>  <?php echo $button_text;?></a></div>
</div>
    </div>
 <?php else:?>
