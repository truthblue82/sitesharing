...
// section team
   ...
   $section_class = 'section magee-section alchem-home-section-6 alchem-home-style-4';
...
<section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  <div class="section-content" style="color:<?php echo $section_color;?>;">
    <div class="container alchem_section_6_model">
      ...
      <h1 class="magee-heading" style="text-align: center;margin-bottom:40px;"><span class="heading-inner alchem_section_6_title" style="font-size: 62px;"> <span style="font-family: 'Cabin Condensed';font-size:24px;color:#fff;"><?php echo $section_title;?></span></span></h1>
      <p style="text-align: center; color: #fff; font-size: 16px;" class="alchem_section_6_sub_title"><?php echo do_shortcode($sub_title);?></p>
