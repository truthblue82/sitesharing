<?php
  // section testimonials 
   ...
   $section_class = 'section magee-section alchem-home-section-7 alchem-home-style-4';
...
<section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  <div class="section-content" style="color:<?php echo $section_color;?>;">
    <div class="container alchem_section_7_model">
      ...
      <h1 class="section-title alchem_section_7_title" style="text-align:center;margin-bottom:30px;color: #fff;"><?php echo $section_title;?></h1>
      <div style="text-align:center;color: #fff;" class="alchem_section_7_sub_title"><?php echo do_shortcode($sub_title);?></div>
	 ...
	 for( $j=0; $j<6; $j++ ){
	  ...
	  $image = '';
	  if( $avatar != '' )
	  $image = '<img src="'.$avatar.'" style="width: 100px; display: inline-block;" class="img-circle">';
	  ...
	  ?>
            ...
            <div class="multi-carousel-nav style2 nav-bg  nav-rounded"> 
              <a href="javascript:;" class="carousel-prev" role="button" data-slide="prev"> 
                <span class="multi-carousel-nav-prev"></span> </a> 
              <a class="carousel-next" href="javascript:;" role="button" data-slide="next"> 
                <span class="multi-carousel-nav-next"></span> </a> 
            </div>
          </div>
        </div>
      </div>
