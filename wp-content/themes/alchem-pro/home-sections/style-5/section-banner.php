<?php 
 ...
 $youtube_mute = 'false';
  ...
  $containment = 'body';
   ...
   $section_class = 'section magee-section alchem-home-section-0 alchem-home-style-5';
  if( $content_model == 3 )
        ...
        <div class="row">
          ...
          <div class=" col-md-3_5">
             <div class="magee-alert" role="alert">
              ...
              <h1 class="magee-heading " style="text-align:center;"><span class="heading-inner <?php echo 'alchem_section_0_sub_title_'.$i;?>" style="font-size: 42px;">
                <p style="text-align: center;  font-size: 20px; font-family: 'Playfair Display';"><?php echo do_shortcode($sub_title);?></p>
                <p class="<?php echo 'alchem_section_0_title_'.$i;?>"><span style="font-family: 'Playfair Display'; "><?php echo do_shortcode($title);?></span></p>
                </span></h1>
              <div style="height: 30px;"></div>
              <div style="text-align: center;" class="<?php echo 'alchem_section_0_btn_text_'.$i;?>">
              <?php if( $btn_text!='' ):?>
                <a href="<?php echo $btn_link;?>" target="<?php echo $btn_target;?>" style="" class=" magee-btn-normal btn-square btn-md"><?php echo $btn_text;?></a>
                 <?php endif;?>
                 </div>
