<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-12 alchem-home-style-6';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
    <h1 class="magee-heading heading-boxed-reverse"><span class="heading-inner alchem_section_12_title"><span style="font-family: 'Playfair Display';"><?php echo $section_title;?></span></span></h1>
      <p style="text-align: left; color: #666666; font-size: 16px; font-family: 'Playfair Display';" class="alchem_section_12_sub_title"><?php echo do_shortcode($sub_title);?></p>
      <div style="height: 50px;" class="alchem_section_12_posts_num"></div>
    <?php endif;?>
	...
	// The Loop 
        ...
        $loop = '';
		$animationtype   = array('fadeInLeft','fadeInRight','zoomIn','fadeInDown','fadeInLeft','fadeInRight');
		if($query->have_posts() ):
		while ($query->have_posts() ) :
		  ...
		  $loop .= '<div class="'.$alchem_home_animation.'" data-animationduration="1.2" data-animationtype="'.$animationtype[$j].'" data-imageanimation="no">';			 
		  $loop .= '<div class="portfolio-box-wrap col-md-'.$col.' '.implode(' ',$cats ).'" data-cat="'.implode(' ',$cats ).'">';
		  ob_start();  
...
// Reset Query
 ...
 <?php endif;?>
  ...
  <div class="magee-section-separator ss-triangle-down"></div>
</section>
<?php endif;?>