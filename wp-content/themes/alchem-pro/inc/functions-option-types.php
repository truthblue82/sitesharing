...
if ( ! function_exists( 'alchem_display_by_type' ) ) {
  ...
  function alchem_display_by_type( $args = array() ) {
    ...
    if ( function_exists( $function_name_by_type ) ) {
      ...
      echo '<p>' . __( 'Sorry, this function does not exist', 'alchem-pro' ) . '</p>';
    }
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        echo '<div class="alchem-background-group">';
          ...
          if ( in_array( 'background-repeat', $alchem_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-repeat]" id="' . esc_attr( $field_id ) . '-repeat" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . __( 'background-repeat', 'alchem-pro' ) . '</option>';
          ...
          if ( in_array( 'background-attachment', $alchem_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-attachment]" id="' . esc_attr( $field_id ) . '-attachment" class="option-tree-ui-select ' . $field_class . '">';
              ...
              echo '<option value="">' . __( 'background-attachment', 'alchem-pro' ) . '</option>';
          ...
          if ( in_array( 'background-position', $alchem_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-position]" id="' . esc_attr( $field_id ) . '-position" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . __( 'background-position', 'alchem-pro' ) . '</option>';
          ...
          if ( in_array( 'background-size', $alchem_recognized_background_fields ) ) {
            ...
            if ( is_array( $choices ) && ! empty( $choices ) ) {
              ...
              echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-size" value="' . ( isset( $field_value['background-size'] ) ? esc_attr( $field_value['background-size'] ) : '' ) . '" class="widefat alchem-background-size-input option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . __( 'background-size', 'alchem-pro' ) . '" />';
        ...
        if ( in_array( 'background-image', $alchem_recognized_background_fields ) ) {
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* add media button */
            echo '<a href="javascript:void(0);" class="alchem_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . __( 'Add Media', 'alchem-pro' ) . '"><span class="icon alchem-icon-plus-sign"></span>' . __( 'Add Media', 'alchem-pro' ) . '</a>';
          ...
          if ( isset( $field_value['background-image'] ) && $field_value['background-image'] !== '' ) {
            ...
            echo '<div class="option-tree-ui-media-wrap" id="' . esc_attr( $field_id ) . '_media">';
              ...
              echo '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . __( 'Remove Media', 'alchem-pro' ) . '"><span class="icon alchem-icon-minus-sign"></span>' . __( 'Remove Media', 'alchem-pro' ) . '</a>';
    ...
    echo '<div class="format-setting type-category-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $categories ) ) {
          ...
          echo '<p>' . __( 'No Categories Found', 'alchem-pro' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<p>' . __( 'No Posts Found', 'alchem-pro' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . __( 'No Posts Found', 'alchem-pro' ) . '</option>';
        }
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $ids ) ) {
          ...
          <div class="alchem-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-secondary hug-left alchem-gallery-delete">' . __( 'Delete Gallery', 'alchem-pro' ) . '</a>
            <a href="#" class="option-tree-ui-button button button-primary right hug-right alchem-gallery-edit">' . __( 'Edit Gallery', 'alchem-pro' ) . '</a>
          </div>';
          ...
          echo '
          <div class="alchem-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-primary right hug-right alchem-gallery-edit">' . __( 'Create Gallery', 'alchem-pro' ) . '</a>
          </div>';
  ...
  function alchem_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add New', 'alchem-pro' ) . '">' . __( 'Add New', 'alchem-pro' ) . '</a>';
        
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'alchem_list_item_description', __( 'You can re-order with drag & drop, the order will update after saving.', 'alchem-pro' ), $field_id ) . '</div>';
    ...
    echo '<div class="format-setting type-radio ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $field_choices = array(
          array(
            'value'   => 'on',
            'label'   => __( 'On', 'alchem-pro' ),
          ),
          array(
            'value'   => 'off',
            'label'   => __( 'Off', 'alchem-pro' ),
          )
        );
  ...
  function alchem_type_page_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
        ...
        echo '<p>' . __( 'No Pages Found', 'alchem-pro' ) . '</p>';
      }
    ...
    echo '<div class="format-setting type-page-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . __( 'No Pages Found', 'alchem-pro' ) . '</option>';
        }
  ...
  function alchem_type_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* description */
        echo '<div class="list-item-description">' . __( 'You can re-order with drag & drop, the order will update after saving.', 'alchem-pro' ) . '</div>';
    ...
    echo '<div class="format-setting type-tag-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<p>' . __( 'No Tags Found', 'alchem-pro' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<option value="">' . __( 'No Tags Found', 'alchem-pro' ) . '</option>';
        }
    ...
    echo '<div class="format-setting type-taxonomy-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<p>' . __( 'No Taxonomies Found', 'alchem-pro' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<option value="">' . __( 'No Taxonomies Found', 'alchem-pro' ) . '</option>';
        }
