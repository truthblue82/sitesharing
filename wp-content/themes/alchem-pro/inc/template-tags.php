...
function alchem_post_nav() {
    ...
    <nav class="post-pagination" role="navigation">
                                       ...
                                       <?php
											previous_post_link( '<li style="float:left" class="nav-previous">%link</li>', __( 'Previous', 'alchem-pro' ) );
											next_post_link(     '<li style="float:right" class="nav-next">%link</li>',     __( 'Next', 'alchem-pro' ) );
										?>
                                        </ul>
                                    </nav>  
                                                ...
                                                <div class="media-body">
                                                    <div class="media-inner">
                                                        <h4 class="media-heading clearfix">
                                                           <?php echo get_comment_author_link();?> - <?php comment_date( $date_format ); ?> <?php edit_comment_link(__('(Edit)', 'alchem-pro'),'  ','') ;?>
                                                           <?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ;?>
                                                        </h4>
                                                        
                                                        <?php if ($comment->comment_approved == '0') : ?>
                                                                 <em><?php _e('Your comment is awaiting moderation.', 'alchem-pro') ;?></em>
                                                                 <br />
                                                              <?php endif; ?>
