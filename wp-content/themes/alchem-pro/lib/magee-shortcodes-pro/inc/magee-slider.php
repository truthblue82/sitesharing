...
// slider
 ...
 function magee_slider_register() {
	...
	$labels = array(
		'name' => __('Magee Slider','magee-shortcodes-pro'),
		'singular_name' => 'Magee Slider',
		'add_new_item' => __('Add New Slider','magee-shortcodes-pro'),
		'edit_item' => __('Edit Slider', 'magee-shortcodes-pro'),
		'new_item' => __('New Slider', 'magee-shortcodes-pro'),
		'view_item' => '',
		'all_items' => 'All Sliders',
		'search_items' => __('Search Slider', 'magee-shortcodes-pro'),
		'not_found' =>  __('Nothing found', 'magee-shortcodes-pro'),
		'not_found_in_trash' => __('Nothing found in Trash', 'magee-shortcodes-pro'),
	);
	...
	$args = array(
		...
		'public' => false,
		'show_ui' => true,
		'menu_icon' =>  MAGEE_URL. 'assets/images/menu-icon-slider.png',
		'can_export' => true,
	...
	foreach( $slider as $slide ):
		...
		<li id="listItem_<?php echo $i ?>"  class="ui-state-default" style="margin-bottom:10px;">
			<div class="widget-content option-item" style="margin:5px; padding:5px;">
				...
				<label for="magee_custom_slider[<?php echo $i ?>][title]"><span><?php _e("Slide Title",'magee-shortcodes-pro');?> :</span><input id="magee_custom_slider[<?php echo $i ?>][title]" name="magee_custom_slider[<?php echo $i ?>][title]" value="<?php  echo stripslashes( base64_decode($slide['title']) );  ?>" type="text" /></label>
				
				<label for="magee_custom_slider[<?php echo $i ?>][caption]"><span style="float:left" ><?php _e("Slide Caption",'magee-shortcodes-pro');?> :</span><textarea name="magee_custom_slider[<?php echo $i ?>][caption]" id="magee_custom_slider[<?php echo $i ?>][caption]"><?php echo stripslashes( base64_decode($slide['caption'])) ; ?></textarea></label>
				<input id="magee_custom_slider[<?php echo $i ?>][id]" name="magee_custom_slider[<?php echo $i ?>][id]" value="<?php  echo $slide['id']  ?>" type="hidden" />
                <a class="sort-item"><?php _e("Sort",'magee-shortcodes-pro');?></a>
				<a class="del-item"><?php _e("Delete",'magee-shortcodes-pro');?></a>
				<div class="clear"></div>
			</div>
		</li>
	<?php endforeach; 
		...
		echo $custom['title0'];
		echo $custom['title1'];
		echo ' <p> '.__("Use the button above to add Slides !",'magee-shortcodes-pro').'</p>';
	}?>
	</ul>
	<div class="clear"></div>
  ...
  <?php
	...
	function magee_slider_edit_columns($columns){
	  $columns = array(
		...
		"slides" => __("Number of Slides",'magee-shortcodes-pro'),
		"date" => __("Date",'magee-shortcodes-pro'),
	  );
