...
class Magee_Accordion {
	...
	function render_child( $args, $content = '') {
		...
		if($background_color !== '')
		$html .= '#'.$panelId.' .panel-heading{
		background-color:'.$background_color.'!important;}
		#'.$panelId.'{border-color:'.$background_color.'!important;}';
		
		if($color !== '')
		$html .= '#'.$panelId.' .panel-title{color:'.$color.'!important;}
		#'.$panelId.' .panel-title i{color:'.$color.';}
		#'.$panelId.' .panel-heading .accordion-toggle:after{color:'.$color.';}';
