...
class Magee_Blog {
	...
	if( $text_domain == 'onetone' && function_exists('onetone_option') )
	$display_image = onetone_option('archive_display_image',MAGEE_DISPLAY_IMAGE);
	if( $text_domain == 'alchem' && function_exists('alchem_option') )
	$display_image = alchem_option('archive_display_image',MAGEE_DISPLAY_IMAGE);
                                                    ...
                                                    <article class="entry-box" role="article">
                                                        ...
                                                        <div class="entry-main">
                                                            <div class="entry-header">' ;
                                                                ...
                                                                $html_item .= '<a href="'.get_permalink().'"><h1 class="entry-title">'.get_the_title().'</h1></a>' ;
                                                                ...
                                                                $html_item .= '<ul class="entry-meta" >
                                                                    ...
                                                                    <li class="entry-comments pull-right">'.Magee_Core::get_comments_popup_link('', __( '<i class="fa fa-comment"></i> 1 ', 'magee-shortcodes-pro'), __( '<i class="fa fa-comment"></i> % ', 'magee-shortcodes-pro'), 'read-comments', '').'</li>
                                                                </ul>';
													        ...
													        $html_item .= '</div>';
																...
																$html_item .= '<div class="entry-summary" >';
																	    if( $strip == 'yes'):
																			 ...
																			 $html_item .= strip_tags(Magee_Core::get_summary($excerpt_length)) ;
																			 else:
																			 $html_item .= strip_tags(Magee_Core::get_summary()) ;
																			 endif;
																		 else:
																			 if(intval($excerpt_length) || intval($excerpt_length)>0):
																			 $html_item .= Magee_Core::get_summary($excerpt_length);
																			 else:
																			 $html_item .= Magee_Core::get_summary() ;
																			 endif;
															 			 endif;	 
														        $html_item .= '</div>';
																else:
	...
	$html_item .= '<div class="'.$class_column.'">
                                                <div class="entry-box-wrap">
                                                    ...
                                                    $html_item .= '<a href="'.get_permalink().'"><h1 class="entry-title">'.get_the_title().'</h1></a>' ;
													if( $display_meta == 'yes')
                                                    $html_item .=  Magee_Core::posted_on();
                                                $html_item .= '</div>' ;
												if( $display_excerpt == 'yes'){
                                                $html_item .= '<div class="entry-summary">';
                                                                     if( $strip == 'yes'):
																			 if(is_int($excerpt_length) || $excerpt_length>0):
																			 $html_item .= strip_tags(substr(Magee_Core::get_summary(),0,$excerpt_length)) ;
																			 else:
																			 $html_item .= strip_tags(Magee_Core::get_summary()) ;
																			 endif;
																	 else:
																			 if(is_int($excerpt_length) || $excerpt_length>0):
																			 $html_item .= Magee_Core::get_summary().substring(0,$excerpt_length) ;
																			 else:
																			 $html_item .= Magee_Core::get_summary() ;
																			 endif;
															 		 endif;	
                                                ...
                                                $html_item .= '<div class="entry-footer">
                                                    <a href="'.get_permalink().'" class="pull-right">'. __('Read More', 'magee-shortcodes-pro').' &gt;&gt;</a>
                                                </div>
                                                        </div>
                                                    </article>
                                                </div>
                                                ...
                                                <article class="entry-box" role="article">
                                                    ...
                                                    <div class="entry-main">
                                                        <div class="entry-header">';
														    ...
														    if( $display_title == 'yes') 
                                                            $html .= '<a href="'.get_permalink().'" style="display:block;"><h1 class="entry-title">'.get_the_title().'</h1></a>';
															
															if( $display_meta == 'yes')
                                                            $html .=  Magee_Core::posted_on();
                                                        ...
                                                        $html .= '<div class="entry-summary">';
														     if( $strip == 'yes'):
																 if(is_int($excerpt_length) || $excerpt_length>0):
																 $html .= strip_tags(substr(Magee_Core::get_summary(),0,$excerpt_length)) ;
																 else:
																 $html .= strip_tags(Magee_Core::get_summary()) ;
																 endif;
															 else:
															 	 if(is_int($excerpt_length) || $excerpt_length>0):
																 $html .= Magee_Core::get_summary().substring(0,$excerpt_length) ;
																 else:
	...
	if($style == '4'){
	 ...
	 if( $page_nav == 'yes')
	 $html .= '<div class="row"><div class="list-pagition text-center">'.Magee_Core::paging_nav("",$wp_query).'</div></div>';
	 $html .= '</div>';
	 wp_reset_postdata();
	 return $html ;	
